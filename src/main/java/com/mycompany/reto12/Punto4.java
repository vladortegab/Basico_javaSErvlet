 ...
 * @author Vladimir
 */
@WebServlet(name = "Punto4", urlPatterns = {"/Punto4"})
public class Punto4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Punto4</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Punto4 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          out.println("<!DOCTYPE html>\n" +
            ...
            "<body>\n" +
            "<h1><b>La Raiz !</b></h1>\n" +
            "<li><b>Raiz Cuadrada es: </b> "   + NumRaiz + 
            "</li>\n" +
            "</body>\n" +
            "</html>");
